...
fig.savefig(figdir / "ngc-346-bow-multi-muse-high-ion.pdf")
...
fig.savefig(figdir / "ngc-346-bow-multi-muse-low-ion.pdf")
...
# +
hduacs = fits.open(bigdir / "ngc346-hst-acs-f658n-wcsgaia.fits")["SCI"]
...
fig.savefig(figdir / "ngc-346-bow-multi-acs-wide.pdf")
...
fig.savefig(figdir / "ngc-346-bow-multi-acs-zoom.pdf")
