...
+ I use jupytext to automatically save ~.py~ and ~.md~ versions of the notebooks
  ...
  + According to the [[https://jupytext.readthedocs.io/en/latest/faq.html][jupytext FAQ]], I can just edit the ~.md~ or ~.py~ version while the notebook is still open in the browser.  It will notice that something has changes and offer me the chance to reload it
