...
1339     Deep Neutral   H_2 4-0 S(3) 6270.24A   True  0.079375  6270.853947  0.240218  0.015254  0.073459  0.037652  0.036408  0.016258     NaN     NaN    NaN    NaN  0.085248  0.028565  6270.67  blend 12-5 S(2)     207.0
...               ...                     ...    ...       ...          ...       ...       ...       ...       ...       ...       ...     ...     ...    ...    ...       ...       ...      ...              ...       ...
...
- [ ] We want to skip any blends that are predicted to be very weak (say < 0.1 of target line)
- [ ] We also want to add in for the sky lines the equivalent wavelength in the nebula frame, and then that is what we sort on
...
#+begin_example
a ['', ' N II 4607.16']
Failed to format blend: [Fe III] 
b ['', ' 4638.86 ', ' N II 4643.06 ', ' N III 4640.64']
Failed to format blend: O II 
c ['', ' 4650.84']
Failed to format blend: O II 
d [' He I 4713.14']
e ['', ' 4985.90']
...
g [' [Fe II] 5273.38']
h ['', ' Fe II 6385.46']
Failed to format blend: Fe II 
i ['H_2 4-0 S(0) 6434.99']
j ['', ' Fe II 6491.2544']
Failed to format blend: Fe II 
k ['', ' OH 6634 sky']
Failed to format blend: H_2 5-1 S(5) 
...
Failed to format blend: Also, several OH sky lines but they are weak and probably do not interfere
p [' 7254.45', ' 7254.53', 'Wavelength followed by + indicates blend. Secondary components should be listed in attached note']
Failed to format blend: Wavelength followed by + indicates blend. Secondary components should be listed in attached note
q [' [Cl IV] 7261.4']
r ['', ' 7318.39']
Failed to format blend: [O II] 
s ['', ' 7329.66 and ', ' [Ar IV] 7331.4']
Failed to format blend: [O II] 
Failed to format blend:  7329.66 and
t ['', ' OH 7473.7 sky']
Failed to format blend: N I 
u [' [Cl IV] 7530.8']
v ['H_2 7-3 S(6) 7638.24']
w ['H_2 9-4 Q(7) 7663.45']
x ['', ' OH 7712 sky', 'H_2 10-5 S(3) 7707.12']
Failed to format blend: H_2 7-3 S(2) 
y ['', ' OH 7726 sky', 'H_2 6-2 Q(6) 7720.70']
Failed to format blend: H_2 12-6 S(2) 
z ['', ' OH 7794 sky', 'H_2 3-0 S(9) 7790.99']
Failed to format blend: H_2 10-5 S(0) 
aa []
ab ['', ' OH 7822 sky']
Failed to format blend: He I 
ac ['', ' OH 7853 sky']
Failed to format blend: H_2 7-3 S(0) 
ad ['', ' OH 7868 sky']
Failed to format blend: H_2 3-0 S(11) 
ae ['', ' OH 7921 sky']
Failed to format blend: H_2 11-5 Q(9) 
af ['', ' OH 7964.65']
Failed to format blend: H_2 3-0 S(3) 
ag ['', ' [Fe II] 7999.47 ', ' [Cr II] 8000.08']
Failed to format blend: [Fe II] 
ah ['', ' OH 8014.1']
Failed to format blend: H_2 7-3 Q(1) 
ai []
aj ['', ' O I 8221.824  ']
Failed to format blend: N I 
ak ['H_2 8-4 S(4) 8266.30']
al ['', ' OH 8288.6 sky']
Failed to format blend: H_2 4-1 S(7) 
am ['', ' H I 8298.83']
Failed to format blend: H_2 4-1 S(6) 
an ['', ' H I 8306.11']
Failed to format blend: H_2 4-1 S(9) 
ao ['', ' H I 8333.782']
Failed to format blend: H_2 4-1 S(5) 
ap ['', ' He I 8361.73']
Failed to format blend: H I 
aq ['', ' OH 8415.2 sky']
Failed to format blend: H I 
ar ['', ' OH 8465.2, ', ' Ca I] 8459.50 perhaps']
Failed to format blend: H_2 4-1 S(3) 
Failed to format blend:  OH 8465.2,
Failed to format blend:  Ca I] 8459.50 perhaps
as ['', ' OH 8548.7 sky']
Failed to format blend: H I 
at ['H_2 3-0 Q(3) 8560.35']
au ['', ' O_2 8651.28']
Failed to format blend: H_2 8-4 Q(1) 
av ['', ' O_2 8676.1']
Failed to format blend: H_2 3-0 Q(5) 
aw ['', ' N I 8683.40, 8686.15, 8680.28']
Failed to format blend: H_2 8-4 Q(2) 
Failed to format blend:  N I 8683.40, 8686.15, 8680.28
ax ['', ' neutral UIL', 'H_2 7-3 Q(9) 8691.59']
Failed to format blend: H_2 14-7 Q(2) 
Failed to format blend:  neutral UIL
ay ['H_2 11-6 Q(1) 8809.76']
az ['H_2 11-6 Q(4) 9049.54']
ba ['H_2 8-4 Q(8) 9297.40']
#+end_example
