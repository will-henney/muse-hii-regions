...
Blend with 4985.90. This is weqfrom the bow shock, but is stronger from the other zones, especially in the west of the nebula.
#+begin_src sh :dir ../data/n346-bow-lines :results file
...
#+RESULTS:
[[file:/Users/will/Dropbox/muse-hii-regions/data/n346-bow-lines/figs-compare/P-007-P-101-o-ii-7319-99.pdf]]
#+begin_src sh :dir ../data/n346-bow-lines :results file
...
#+begin_src sh :dir ../data/n346-bow-lines :results file
  python ../../scripts/compare-two-maps.py --line n-ii-5755-08 --bcombo P-101 --smooth 3 --subtract-bg --mask-out-stars --star-mask-threshold 15 --fix-continuum --continuum-zone II
#+end_src
...
**** [C I] 8727 line
#+begin_src sh :dir ../data/n346-bow-lines :results file
  python ../../scripts/compare-two-maps.py --line c-i-8727-13 --bcombo P-101 --smooth 1  --subtract-bg --mask-out-stars --star-mask-threshold 5 --fix-continuum --continuum-zone 0
#+end_src
