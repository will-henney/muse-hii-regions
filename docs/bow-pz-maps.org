...
#+begin_src sh :dir ../data/n346-bow-lines :results file
  python ../../scripts/compare-two-maps.py --line he-i-5015-68 --bcombo P-101 --smooth 0 --mask-out-stars --star-mask-threshold 10 --subtract-bg
#+end_src
...
#+begin_src sh :dir ../data/n346-bow-lines :results file
python ../../scripts/compare-two-maps.py --line si-iii-5739-73 --bcombo E-007 --smooth 9 --mask-out-stars --star-mask-threshold 2 --subtract-bg
#+end_src
