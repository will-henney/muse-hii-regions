...
- [2024-05-10 Fri] Future plans are as follows
  - [ ] Define a BG zone to extract a spectrum that we will subtract from all the other zones
...
#+begin_src sh :dir ../data/n346-bow-lines :results file
python ../../scripts/compare-two-maps.py --line ar-iv-4740-17 --bcombo E-007 --subtract-bg
#+end_src
