...
** TODO [0/0] Return to bow project 2023 Summer and 2025 Winter
...
**** TODO [/] Redoing figures

***** TODO Figure 3 - spatial cuts across bow
- [-] First job: make the lettering bigger so that we can show it as a single column
