...
- So finally the ratio is \int d r / \int d z = 40 / 10 = *0.25*
...
**** Rematch for the He++ ionization fraction
...
- Uncertainties in the ingredients that go into \tau
  ...
  - n = 35 +/- 10 cm^-3 (relative uncertainty 30%) from the jump in H beta surface brightness
  - dr = 10 +/- 2 pixels (relative uncertainty 20%) giving 1.846e18 cm
- Putting it all together
  - \tau = 0.5 1.5e-18 0.0824 35 1.846e18 = 4.0
  - x = 0.75
  - Adding the uncertainties in quadrature gives sqrt(0.5**2 + 0.05**2 + 0.3**2 + 0.2**2) = 0.62
  - So \tau = 4.0 +/- 2.5 and x = 0.75 +/- 0.16
**** The dilemma of the He++ ionization fraction
- Result from the shell analysis taken at face value is x = 0.75 +/- 0.16
...
- So on the face of it, we need that the shell is only 2% of the total emission measure
  - This is much less then one would naturally think
