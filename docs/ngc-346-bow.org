...
** Return to bow project 2023 Summer
- What remains to be done?
  - [-] Rerun all the notebooks since I seem to have lost all the results cells
    - Looks like best way is with nbconvert
    - 
  - [ ] Maybe repeat for the Peter Zeigler cube
  - [ ] Think what are the essentials for the paper
*** TODO Rerunning the notebooks [2023-06-01 Thu]
