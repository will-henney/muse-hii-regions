...
- Putting it all together
  - \tau = 0.5 1.5e-18 0.0824 35 1.6e18 = 3.46
  - x = 0.71
  - Adding the uncertainties in quadrature gives sqrt(0.5**2 + 0.05**2 + 0.3**2 + 0.2**2) = 0.62
  - So \tau = 3.5 +/- 2.2 and x = 0.7 +/- 0.2
**** The dilemma of the He++ ionization fraction
- Result from the shell analysis taken at face value is x = 0.7 +/- 0.2
...
- So density is sqrt(6.59e21 / 1.08 1.66e19) = (19 +/- 8) cm^-3
