...
python ../../scripts/spec1d-find-peaks.py n346-nostar-bs.fits
#+end_src

#+RESULTS:
: n346-nostar-bs-peaks-p0030-d0030.csv

- This has found 101 lines in all
...
***** Globule region
#+begin_src sh :dir ../data/spec1d 
    python ../../scripts/spec1d-find-peaks.py n346-nostar-glob.fits
#+end_src

#+RESULTS:
: n346-nostar-glob-peaks-p0030-d0030.csv
