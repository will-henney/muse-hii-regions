...
#+begin_src sh :dir ../data/n346-lines :results verbatim
  python ../../scripts/make-one-map.py 3692.yaml
#+end_src

#+RESULTS:
: Image saved to type-med-neb/3692-he-i-9210-28.fits


#+begin_src sh :dir ../data/n346-lines :results verbatim
python ../../scripts/make-one-map.py 1547.yaml
#+end_src
...
#+begin_src sh :dir ../data/n346-lines/type-deep-neutral :results verbatim
python ../../../scripts/combine-maps.py --pattern "*-uil-*" --prefix all-uil --min-strength 5.0
#+end_src
