...
- [ ] Make a top-ten table of the best lines
- [ ] Better treatment of the H I line blends
- [ ] Add the annotations to the remaining one-d spectra
- [ ] Finish writing the paper
**** TODO Top-ten line list
...
- ✘ 8333.95 This is beautifully strong, but is blended with a H line, so i impossible to measure for the other zones
