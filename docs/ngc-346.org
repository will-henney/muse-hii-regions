...
#+begin_src python :results output verbatim
  import pyneb as pn
  print(pn.atomicData.getDataFile(atom="S2"))
  pn.atomicData.printAllSources(at_set=["S2"])
#+end_src
...
- UNIDENTIFIED at 8660 approx
  ...
  - Look for more of these lines
    ...
    - Line at 8044 from filaments that blends with [Cl IV] 8045
      - perhaps 8039 is from same multiplet, in which case it can be removed
      - In 30 Dor there is no sign of this line at all
    - More from the 7800-8200 range
      - 7802, 7838, 7891, 7959, 8009, 8039, 8069 super weak, 8083, 8193 weak
