...
**** TODO [0/1] Comments and plans for the line maps
...
**** TODO Classification in a big collaborative spreadsheet
...
**** Read in data from the spreadsheet and write to individual JSON files
...
- Plan here is to read in excel file and to write out a bunch of little json or yaml files, one per emission line
...
python ../scripts/spreadsheet-convert.py spec1d/All-Lines-MUSE-NGC-346.xlsx
#+end_src
...
#+begin_src sh :dir ../data/n346-lines :results verbaatim
  python ../../scripts/make-one-map.py 1626.yaml
#+end_src

#+RESULTS:
: Image saved to type-deep-neutral/1626-uil-6628-89.fits


#+begin_src sh :dir ../data/n346-lines :results verbaatim
python ../../scripts/make-one-map.py 1987.yaml
#+end_src

#+RESULTS:
: Image saved to type-deep-neutral/1987-uil-7078-89.fits
