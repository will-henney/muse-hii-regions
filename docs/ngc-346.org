...
*** Step 10: Final figures showing highlights from the spectra
...
*** TODO Step 12: Distribution of nearest neighbors and reciprocity
...
**** Plot neighbor parameters versus wavelength
...
- First attempt uses rolling average with a certain window size (in unit of number of table rows)
  ...
  - And if I make the winfow width too high, then we lose lots of the types entirely
...
**** TODO Make a plot of nearest neighbor distribution
