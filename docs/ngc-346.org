...
+ The observationally derived Q2 is 45.62
  + [2024-04-12 Fri] Updated to slightly higher value
  + For T = 50,000 K this is in between the SMC-OB-I (intermediate wind) and SMC-OB-II (strong wind) 50-42 models
    + (62 - 41) / (74 - 41) = 0.64 is the fraction between I and II => log Mdot = -6.02 => Mdot = 1.05e-6
    + The weaker wind has 6x too small a value of Q2
  + The higher gravity model (50-44) would require a slightly stronger wind to get, which has Mdot = 2.3e-6
