...
|               | cliv | 8049.94 |     -2 |    20 |
|               | cliv | 8048.69 |     -2 |    10 |
| oiii 5006.84  | oiii | 5011.22 | -10000 | 25000 |
|               | oiii | 5009.97 | -25000 | 65000 |
|               | oiii | 5008.72 | -25000 | 60000 |
...
|               | oi   | 8451.19 |      0 |    40 |
|               | oi   | 8449.94 |      0 |    30 |
| oiii 4958.91  | oiii | 4962.47 |  -6000 | 15000 |
|               | oiii | 4961.22 |  -7000 | 20000 |
|               | oiii | 4959.97 |  -3000 |  8000 |
| siii 9068.90  | siii | 9074.94 |   -200 |  2000 |
|               | siii | 9073.69 |   -400 |  3500 |
|               | siii | 9072.44 |   -300 |  2000 |
...
#+begin_src python :return plotfile :results file
  ...
  cmap1 = cmr.get_sub_cmap("cmr.fall", 0.25, 0.75)
  cmap2 = cmr.get_sub_cmap("cmr.horizon_r", 0.25, 0.75)
  c1 = ax.contour(
      mu, sig, m1,
      levels=levels,
      cmap=cmap1,
  ...
  ax.clabel(c1, c1.levels[::2], inline=True)
  ax.clabel(c2, c2.levels[1::2], inline=True)
...
#+begin_src python :return plotfile :results file
  ...
  m1_grid, m2_grid = np.meshgrid(
      np.linspace(0.0, 1.0, 2 * N),
      np.linspace(0.0, 1.0, 2 * N),
  )

  points = (m1[mask], m2[mask])
  xi = (m1_grid, m2_grid)
  mu = griddata(points, mu_grid[mask], xi, method="nearest")
  sig = griddata(points, sig_grid[mask], xi, method="nearest")
  ...
  #ax.clabel(c1, c1.levels, inline=True)
