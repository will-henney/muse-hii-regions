...
*** DONE Step 3: filter out the false positives
...
*** DONE Step 4: classify different line types
...
#+begin_src sh :dir ../data/n346-lines :results verbatim
  python ../../scripts/make-one-map.py 3711.yaml
#+end_src
...
*** TODO Step 6: Create spectra and sum each line for each map zone
...
: sys	0m5.468s
: Last run:
: Fri Oct 28 21:30:46 CDT 2022

**** Script to extract per-zone spectra from cubes and write FITS files
...
python ../../../scripts/spec1d-plot-all-zones.py c007-mean --linthresh=30.0
#+end_src

#+RESULTS:
[[file:/Users/will/Dropbox/muse-hii-regions/data/n346-lines/zone_spectra/spec1d-all-zones-c007-mean.pdf]]

#+begin_src sh :dir ../data/n346-lines/zone_spectra :results output file
python ../../../scripts/spec1d-plot-all-zones.py c007-median --linthresh=10.0 --star-scale 3.0
#+end_src

#+RESULTS:
[[file:/Users/will/Dropbox/muse-hii-regions/data/n346-lines/zone_spectra/spec1d-all-zones-c007-median.pdf]]

*** Step 7: Inter-zone ratios
...
*** Step 8: Final figures showing highlights from the spectra
