...
**** TODO Write tables with the ratios
:PROPERTIES:
...
**** TODO Make a table of rest wavelengths plus uncertainties of all the UILs
...
#+end_src
#+begin_src sh :dir ../data/n346-lines :results output file
  python ../../scripts/make-table-uil-waves.py c007-chop-mean
#+end_src
