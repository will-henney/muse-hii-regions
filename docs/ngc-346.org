...
- [ ] First, I should combine the regions into one file
**** Script to extract 1D spectra for each region
:PROPERTIES:
:header-args:python: :tangle ../scripts/extract-region-spectra.py
...
#+begin_src python
  ...
  def get_spectrum_from_region(
      ...
      """Extract 1D spectrum from region"""
      try:
...
Usage of script. Note setting of ~COLUMNS~ to make sure output is not too wide
...
Options:
  --out-prefix TEXT      [default: n346-muse]
  --data-path PATH       [default: /Users/will/Work/Muse-
                         Hii-Data/SMC-NGC-346]

  --cube-name TEXT       [default:
                         ADP.2017-10-16T11_04_19.247.fits]
